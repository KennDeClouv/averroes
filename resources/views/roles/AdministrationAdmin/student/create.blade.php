                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-9">
                                        <select class="form-select select2 @error('uniform_size') is-invalid @enderror" id="uniform_size" name="uniform_size">
                                            ...
                                            <option value="2XL" {{ old('uniform_size') == '2XL' ? 'selected' : '' }}>2XL</option>
                                            <option value="3XL" {{ old('uniform_size') == '3XL' ? 'selected' : '' }}>3XL</option>
                                        </select>
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control @error('attachment_father_identity_card') is-invalid @enderror"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control @error('attachment_mother_identity_card') is-invalid @enderror"
