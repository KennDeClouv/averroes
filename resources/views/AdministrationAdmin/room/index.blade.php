        ...
        <div class="card">
            ...
            <div class="card-body pb-0 pt-4">
                <div class="d-flex justify-content-end">
                    <a href="{{ route('administrationadmin.room.create') }}" class="btn btn-primary mb-3" data-bs-toggle="tooltip"
                    ...
                    <tbody>
                        @foreach ($rooms as $room)
                            <tr>
                                ...
                                <td>{{ $room->code ?? '-' }}</td>
                                <td>
                                    <a href="{{ route('administrationadmin.room.show', $room->id) }}" data-bs-toggle="tooltip"
                                        data-bs-placement="top" title="Detail Kamar" class="btn btn-info "><i
                                            class="fa-solid fa-eye fs-6"></i></a>
                                    <a href="{{ route('administrationadmin.room.edit', $room->id) }}" data-bs-toggle="tooltip"
                                        data-bs-placement="top" title="Edit Kamar" class="btn btn-warning "><i
                                            class="fa-solid fa-edit fs-6"></i></a>
                                    <a href="{{ route('administrationadmin.room.list', $room->id) }}" class="btn btn-secondary"
