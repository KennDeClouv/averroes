                        ...
                        @foreach ($announcements as $announcement)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <x-delete :route="route('administrationadmin.announcement.destroy', $announcement->id)" :message="'Apakah anda yakin ingin menghapus pengumuman ini?'" :title="'Hapus Pengumuman'"></x-delete>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
