...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h5 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light"><a href="{{ route('admin.room.index') }}">Daftar Kamar</a> / <a
                    href="{{ route('admin.room.list', $room->id) }}">Kamar {{ $room->name }}</a> / </span>
            Tambah Santri
        </h5>
        <form action="{{ route('admin.room.add.student-to-room', $room->id) }}" method="post">
            @csrf
            <div class="card">
