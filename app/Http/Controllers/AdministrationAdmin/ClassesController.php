...
class ClassesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('administrationadmin.class.index')->with('success', 'Kelas berhasil ditambahkan!');
    }
    ...
    public function update(Request $request, Classes $class)
    {
        ...
        return redirect()->route('administrationadmin.class.index')->with('success', 'Kelas berhasil diubah!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('administrationadmin.class.index')->with('success', 'Kelas berhasil dihapus!');
    }
    ...
    public function addStudentToClass(Request $request, Classes $class)
    {
        ...
        return redirect()->route('administrationadmin.class.list', $class->id)->with('success', 'Santri berhasil ditambahkan ke kelas!');
    }
}
