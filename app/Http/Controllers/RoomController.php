...
class RoomController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.room.index')->with('success', 'Kamar berhasil ditambahkan!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.room.index')->with('success', 'Kamar berhasil diubah!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.room.index')->with('success', 'Kamar berhasil dihapus!');
    }
    ...
    public function list($id)
    {
        $room = Room::findOrFail($id);
        $students = $room->Students;
        return view('admin.room.list', compact('room', 'students'));
    }
    ...
    public function addStudentToRoomForm(Room $room)
    {
        ...
        return view('admin.room.addlist', compact('room', 'students'));
    }
    public function addStudentToRoom(Request $request, Room $room)
    {
        ...
        return redirect()->route('admin.room.list', $room->id)->with('success', 'Santri berhasil ditambahkan ke kamar!');
    }
}
