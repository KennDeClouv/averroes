...
class StudentPermitController extends Controller
{
    public function index()
    {
        ...
        switch ($role) {
            case 'admin':
                ...
                return view('admin.student-permit.index', compact('studentPermits'));
    ...
    public function create()
    {
        ...
        switch ($role) {
            case 'admin':
                ...
                return view('admin.student-permit.create', compact('students', 'teachers'));
    ...
    public function store(Request $request)
    {
        ...
        switch ($role) {
            case 'admin':
                return redirect()->route('admin.student-permit.index')->with('success', 'Permohonan izin santri berhasil dibuat.');
    ...
    public function show(StudentPermit $studentPermit)
    {
        ...
        switch ($role) {
            case 'admin':
                return view('admin.student-permit.show', compact('studentPermit'));
    ...
    public function edit(StudentPermit $studentPermit)
    {
        ...
        switch ($role) {
            case 'admin':
                $students = Student::all();
                $teachers = Teacher::all();
                return view('admin.student-permit.edit', compact('studentPermit', 'students', 'teachers'));
    ...
    public function update(Request $request, StudentPermit $studentPermit)
    {
        ...
        switch ($role) {
            case 'admin':
                return redirect()->route('admin.student-permit.index')->with('success', 'Permohonan izin santri berhasil diubah.');
    ...
    public function destroy(StudentPermit $studentPermit)
    {
        ...
        switch ($role) {
            case 'admin':
                return redirect()->route('admin.student-permit.index')->with('success', 'Permohonan izin santri berhasil dihapus.');
            case 'student':
